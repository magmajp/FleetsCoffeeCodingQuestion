...
var outputBox = <HTMLElement>document.getElementById("output");
...
function FirstNonRepeated(s: string): string {
    ...
    var frequency:number[] = new Array(256);
...
function Button(){
    ...
    var input:string = (<HTMLInputElement>textBox).value; 

    var output:string = FirstNonRepeated(input);
